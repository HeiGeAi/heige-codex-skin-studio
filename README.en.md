...
- **13 built-in presets**: the high-detail `Miku 488137`, two lightweight themes each for Genshin Impact, Wuthering Waves, Naruto, and Love and Deepspace, two Dragon Ball themes, one bright readable Caishen theme, plus one easter-egg preset.
